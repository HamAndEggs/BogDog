...
#ifndef __GLSHADERCOLOURTEX_H__
#define __GLSHADERCOLOURTEX_H__
...
struct GLShaderColourTex : GLShader
{
	static GLShaderColourTex* Allocate();
	virtual ~GLShaderColourTex();
